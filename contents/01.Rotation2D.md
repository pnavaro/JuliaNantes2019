...
# 2D Rotation Problem: Advection Equation

## Introduction

This notebook demonstrates how to solve a **2D rotation advection problem** using spectral methods in Julia. The problem serves as an excellent case study for:
...
### The Rotation Advection Equation
